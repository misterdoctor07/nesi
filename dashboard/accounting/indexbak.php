      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="?manageleaveapplication">Leave Applications</a></li>
              <li><a href="?manageovertime">Overtime Application</a></li>
              <li><a href="?managebenefits">Manage Benefits</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
