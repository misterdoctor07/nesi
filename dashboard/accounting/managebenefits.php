...
<div class="col-lg-12">
            <div class="content-panel">
              ...
              <h4><a href="?companybenefits"><i class="fa fa-arrow-left"></i> BACK</a> | <i class="fa fa-file-text"></i> EMPLOYEE BENEFITS</h4>              
            </div>
                      ...
                      if(mysqli_num_rows($sqlEmployee)>0){
                        while($company=mysqli_fetch_array($sqlEmployee)){                                                    
                          ...
                          echo "<tr>";
                            ...
                            ?>
                            <td align="center"> 
                              <a href="?editbenefits&id=<?=$company['idno'];?>&company=<?=$cmpy;?>" class="btn btn-success btn-xs" title="Manage Benefits"><i class='fa fa-edit'></i></a>                                                           
