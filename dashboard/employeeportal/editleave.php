...
if (isset($_GET['submit']) && isset($_GET['editleave']))  {
    ...
    if (mysqli_num_rows($sqlCheck) > 0) {
        ...
        // if ($sqlUpdateLeave) {
        //     $sqlGetCredits = mysqli_query($con, "SELECT * FROM leave_credits WHERE idno='$userId'");
        //     $credit = mysqli_fetch_array($sqlGetCredits);
        //     $oldLeavetype = $leaveDetails['leavetype'];
        //     $oldNumberofdays = $leaveDetails['numberofdays'];
        ...
        //                                                     SET vlused = vlused - '$oldNumberofdays' 
        //                                                     WHERE idno = '$idno'");
        //             break;
        //         case 'SL':
        //             $sqlUpdateCredits = mysqli_query($con, "UPDATE leave_credits 
        //                                                     SET slused = slused - '$oldNumberofdays' 
        //                                                     WHERE idno = '$idno'");
        //             break;
        //         case 'PTO':
        //             $sqlUpdateCredits = mysqli_query($con, "UPDATE leave_credits 
        //                                                     SET ptoused = ptoused - '$oldNumberofdays' 
        //                                                     WHERE idno = '$idno'");
        //             break;
        //         case 'BLP':
        //             $sqlUpdateCredits = mysqli_query($con, "UPDATE leave_credits 
        //                                                     SET blp_used = blp_used - '$oldNumberofdays' 
        //                                                     WHERE idno = '$idno'");
        //             break;
        //         case 'EO':
        //             $sqlUpdateCredits = mysqli_query($con, "UPDATE leave_credits 
        //                                                     SET eo_used = eo_used - '$oldNumberofdays' 
        //                                                     WHERE idno = '$idno'");
        //             break;                                        
        //         default:
