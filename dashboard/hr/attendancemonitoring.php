...
?>
            ...
            <div class="content-panel">
              ...
              <h4>
                <a href="?attendancemonitoring&company=<?=$comp;?>?attendancemonitoring&departments=<?$dept;?>&startdate=<?=$startdate;?>&enddate=<?=$enddate;?>"><i class="fa fa-times"></i></a> | Manage Attendance Infractions
            </h4>
            </div>
            ...
            if(isset($_GET['submitInfraction'])){
                ...
                if($sqlInsert){
                  ...
                  echo "<script>window.location='?attendancemonitoring&view&company=$comp&startdate=$startdate&enddate=$enddate&idno=$idno';</script>";
                }else{
                  echo "<script>alert('Unable to insert infraction!');window.location='?attendancemonitoring&view&company=$comp&startdate=$startdate&enddate=$enddate&idno=$idno';</script>";
                }
            }
            ...
            if(isset($_GET['deletetime'])){
              ...
              echo "<script>";
                echo "alert('Item successfully removed!');window.location='?attendancemonitoring&view&idno=$idno&company=$company&startdate=$startdate&enddate=$enddate';";
              echo "</script>";
            }else{
              echo "<script>";
                echo "alert('Unable to delete time!');window.location='?attendancemonitoring&view&idno=$idno&company=$company&startdate=$startdate&enddate=$enddate';";
              echo "</script>";
              }
            }
            if(isset($_GET['deleteinfraction'])){
              ...
              echo "<script>";
                echo "alert('Infraction successfully removed!');window.location='?attendancemonitoring&view&idno=$idno&company=$company&startdate=$startdate&enddate=$enddate';";
              echo "</script>";
            }else{
              echo "<script>";
                echo "alert('Unable to remove infraction!');window.location='?attendancemonitoring&view&idno=$idno&company=$company&startdate=$startdate&enddate=$enddate';";
              echo "</script>";
              }
            }
            ?>
