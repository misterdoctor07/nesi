                  ...
                  <tbody>
                    ...
                    mysqli_query($con,"SET NAMES 'utf8'");
										if(isset($_GET['submit'])){
											...
											$sqlEmployee=mysqli_query($con,"SELECT ep.*,ed.* FROM employee_profile ep LEFT JOIN employee_details ed ON ed.idno=ep.idno WHERE ed.status NOT LIKE '%RESIGNED%' AND ed.company='$dept' AND (ep.lastname LIKE '%$searchme%' OR ep.firstname LIKE '%$searchme%') ORDER BY ed.department ASC");
										}else{
                    ...
                    $searchme = isset($_GET['searchme']) ? $_GET['searchme'] : '';
                          ...
                          echo "<tr>";
                            ...
                            for($i=1;$i<=$datearray;$i++){
                              ...
                              if(mysqli_num_rows($sqlAttendance)>0){
                                ...
                                if($remarks=="Code L" || $remarks=="Code I"){
                                  $remarks="P";
                                  $color="";
                                }
                                if($remarks=="PTO" || $remarks=="VL" || $remarks=="SL" || $remarks=="BLP"){
																	if($remarks=="SL"){
																		$remarks="SL-A";
																	}
