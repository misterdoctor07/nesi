<div class="col-lg-12">
            <div class="content-panel">
                    ...
                    $x=1;
                      ...
                      if(mysqli_num_rows($sqlEmployee)>0){
                        while($company=mysqli_fetch_array($sqlEmployee)){
                          ...
                          $dateofregular=date('F d, Y',strtotime('8 months',strtotime($company['dateofregular'])));
              ...
              if ($currentMonth == $dateHiredMonth && $currentDay == $dateHiredDay) {
                ...
                $sqlResetCredits = mysqli_query($con, "UPDATE leave_credits SET vlused = 0, slused = 0, ptoused = 0, blp_used = 0, eo_used = 0, slp_used = 0 WHERE idno = '$company[idno]'");
            }
