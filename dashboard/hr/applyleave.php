...
<div class="row">
    <div class="col-lg-12">
        <h4 style="text-indent: 10px;"><a href="?main"><i class="fa fa-arrow-left"></i> BACK</a> | <i class="fa fa-road"></i> LEAVE APPLICATION</h4>
    </div>
</div>
    ...
    <div class="col-lg-4 mt">
        <div class="content-panel">
            <div class="panel-heading">
                ...
                <h4><i class="fa fa-user"></i> LEAVE APPLICATIONS</h4>
            </div>
