...
<script type="text/javascript">
    ...
    <div class="col-lg-4 mt">
            ...
            <div class="panel-body">                                            
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="eo_out" style="text-align:center;" value="<?=$eaused;?>">
                  </div>
                </div>
            </div>
          </div>
  ...
  <?php
    if(isset($_GET['submit'])){
        ...
        $probationary=$_GET['vacation'];
        $probationarydate=$_GET['sick'];
        $regular=$_GET['pto'];  
        ...
        if(mysqli_num_rows($sqlCheck)>0){
            $table="leave_credits";
            $values="SET vacationleave='$probationary',vlused='$vlused',sickleave='$probationarydate',slused='$slused',pto='$regular',ptoused='$ptoused',updatedby='$addedby',updateddatetime='$datenow' WHERE idno='$idno'";
            $sqlAddEmployee=mysqli_query($con,"UPDATE $table $values");
        }else{
            $table="leave_credits(idno,vacationleave,vlused,sickleave,slused,pto,ptoused,addedby,addeddatetime)";
            $values="VALUES('$idno','$probationary','$vlused','$probationarydate','$slused','$regular','$ptoused','$addedby','$datenow')";
