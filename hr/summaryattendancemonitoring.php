                                        ...
                                        if (mysqli_num_rows($sqlAttendance) > 0) {
                                            while ($attend = mysqli_fetch_array($sqlAttendance)) {
                                                ...
                                                $colorLogoutPM = "";
                                                   ...
                                                   // Build the output strings with the appropriate colors
                                                    $login1 .= "<font $color>" . (($attend['loginam'] === "00:00:00" || $attend['loginam'] === "0") ? "00:00:00" : date('h:i A', strtotime($attend['loginam']))) . "</font><br>";
                                                    $logout1 .= "<font $colorLogoutAM>" . (($attend['logoutam'] === "00:00:00" || $attend['logoutam'] === "0") ? "00:00:00" : date('h:i A', strtotime($attend['logoutam']))) . "</font><br>";
                                                    $login2 .= "<font $colorLoginPM>" . (($attend['loginpm'] === "00:00:00" || $attend['loginpm'] === "0") ? "00:00:00" : date('h:i A', strtotime($attend['loginpm']))) . "</font><br>";
                                                    $logout2 .= "<font $colorLogoutPM>" . (($attend['logoutpm'] === "00:00:00" || $attend['logoutpm'] === "0") ? "00:00:00" : date('h:i A', strtotime($attend['logoutpm']))) . "</font><br>";
                                                ...
                                                $action .= "<a href='?attendancemonitoringsummary&edit&company=$comp&startdate=$startdate&enddate=$enddate&idno=$idno&logindate={$attend['logindate']}'>
                                                              ...
                                                              <a href='?attendancemonitoring&idno=$idno&id={$attend['id']}&deletetime&company=$comp&startdate=$startdate&enddate=$enddate&logindate={$attend['logindate']}' title='Delete Time' onClick='return confirm(\"Are you sure to delete this one mister/sister?\");'>
                ...
                $colorLogoutPM = "";
                            ...
                            if (isset($attend['logoutam']) && isset($attend['loginpm'])) {
                                ...
                                if ($interval > 3600) { // Overbreak threshold (1 hour)
                                    ...
                                    // Build the output strings with the appropriate colors
                                                                    // Build the output strings with the appropriate colors
                                    $login1 .= "<font $color>" . (($attend['loginam'] === "00:00:00" || $attend['loginam'] === "0") ? "-" : date('h:i A', strtotime($attend['loginam']))) . "</font><br>";
                                    $logout1 .= "<font $colorLogoutAM>" . (($attend['logoutam'] === "00:00:00" || $attend['logoutam'] === "0") ? "-" : date('h:i A', strtotime($attend['logoutam']))) . "</font><br>";
                                    $login2 .= "<font $colorLoginPM>" . (($attend['loginpm'] === "00:00:00" || $attend['loginpm'] === "0") ? "-" : date('h:i A', strtotime($attend['loginpm']))) . "</font><br>";
                                    $logout2 .= "<font $colorLogoutPM>" . (($attend['logoutpm'] === "00:00:00" || $attend['logoutpm'] === "0") ? "-" : date('h:i A', strtotime($attend['logoutpm']))) . "</font><br>";
