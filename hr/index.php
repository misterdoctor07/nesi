      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <?php
              ...
              $query = "SELECT COUNT(*) AS total FROM leave_application WHERE appstatus != 'Pending' AND appstatus != 'Cancelled' AND appstatus != 'Disapproved' AND remarks != 'POSTED'";
          ...
          <li class="sub-menu">
              <a href="javascript:;">
                ...
                <?php if ($leave_count > 0) { ?>
                    <span class="badge-leave"><?php echo $totalCount; ?></span>
                  <?php } ?>
              </a>
              <ul class="sub">
